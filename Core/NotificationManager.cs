...
namespace XKeyboard.Core
{
    ...
    class NotificationManager
    {
        ...
        public static void Initiate()
        {
            ...
            Log("NotificationManager.Initiate(): Initializing NotifyIcon...");
            ...
            Log("NotificationManager.Initiate(): Initializing Context Menu Items...");
            //Exit item
            ...
            /////TO-DO/////
                /// Implement more settings and features like Disable Mouse input.
            ///////////////
            //About menu item
            ...
            {
                Log("NotificationManager.SettingsChanged(): Applying UI Params...");
            ...
            {
                #region MenuPopup
                Log("NotifyIcon.Popup(): Loading font sets & ui...");
               ...
               // itemKeyboard.MenuItems.Add(itemKeyboardIntercept);
            ...
            {
                Logger.Save();
                if (System.IO.File.Exists(Application.StartupPath + "\\logs.txt"))
            ...
            var itemKeyboardClick = new EventHandler((oo, ee) =>
            {
                ...
                switch (((MenuItem)oo).Name)
                {
                    ...
                    case nameof(itemKeyboardEnabled):
                        ...
                        break;
                    //case nameof(itemKeyboardIntercept):
                    //    //Intercept keyboard.
                    //    Program.kManager.KeyboardState = KeyboardState.Intercept;
                    //    break;
                }
            ...
            //itemKeyboardIntercept.Click += itemKeyboardClick;
            ...
            {
                if (System.IO.File.Exists(Application.StartupPath + "\\logs.txt"))
                    System.Diagnostics.Process.Start(Application.StartupPath + "\\logs.txt");
            };
            settingsChanged();
        }
        /// <summary>
